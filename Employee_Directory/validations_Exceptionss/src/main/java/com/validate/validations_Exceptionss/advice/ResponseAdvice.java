...
public class ResponseAdvice {
	...
	@ResponseStatus
	@ExceptionHandler(MethodArgumentNotValidException.class)//Exception Handler for data validation
	...
	//Exception Handler for User already have account
	...
	//Exception Handler for User not found with given id
